 ...
 * @hide
 */
public interface IKeystoreServiceM extends IInterface {
    ...
    //int generate(String name, int uid, int keyType, int keySize, int flags, /*in*/ KeystoreArguments args);
...
//    int generateKey(String alias, in KeymasterArguments arguments, in byte[] entropy, int uid, int flags, out KeyCharacteristics characteristics);
